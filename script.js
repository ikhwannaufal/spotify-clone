...
var redirect_uri = 'https://guileless-florentine-d5e395.netlify.app/callback'; 
...
function displayUserTopItems(data) {
    ...
    sectionSubtitle.textContent = "Based on you recent listening";
...
function displayUserNewReleases(data) {
...
async function fetchFeaturedPlaylists() {
    try {
        ...
        displayUserFeaturedPlaylists(data);
    } catch (error) {
        alert("Something went wrong.");
        console.log(error);
    }
...
function displayUserFeaturedPlaylists(data) {
